...
PREFIX = "registry.cn-shanghai.aliyuncs.com/yoly"
VERSION = "1.4"
...
def docker_login():
    username = os.getenv("DOCKER_USERNAME") or "yongli0510"
    docker_hub_address = os.getenv("DOCKER_HUB_ADDRESS") or "registry.cn-shanghai.aliyuncs.com"
